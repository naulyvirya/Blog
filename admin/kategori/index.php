                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header">Data Kategori
                              ...
                              data-target=".kategori">Tambah</button>
                          </div>
                                  ...
                                  <table class="table" id="data-table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/kategori/proses.php?id=<?php echo $data['id']; ?>
                                                &aksi=delete" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin ?')">Delete</a> |
                                                <button type="button" class="btn btn-sm btn-warning btn-outline" data-toggle="modal"
                                                data-target=".kategori-<?php echo $data['id']; ?>">Edit</button> |
                                                <button type="button" class="btn btn-sm btn-success btn-outline" data-toggle="modal"
                                                data-target=".kategori-show-<?php echo $data['id']; ?>">Show</button>
                                            </td>
                                        </tr>
